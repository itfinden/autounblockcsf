...
function autounblockcsf_config() {
	...
	$configarray = array(
		...
		"language" => "english",
		"fields" => array(
			"unblock_email" => array("FriendlyName" => "To: Email address", "Type" => "text", "Size" => "30", "Description" => "Dirección de correo electrónico para enviar el registro de acciones"),
			"from_email" => array("FriendlyName" => "From: Email address", "Type" => "text", "Size" => "30", "Description" => "Dirección de correo electrónico del remitente (dejar en blanco por defecto- Autounblock@" . $GLOBALS['autounblockcsf']['ENV']['SERVER_NAME'] . ")"),
			"client_alert" => array("FriendlyName" => "Client unblock alert", "Type" => "yesno", "Size" => "30", "Description" => "Enviar alertas para la acción de desbloqueo del cliente", "Default" => "on"),
			"admin_alert" => array("FriendlyName" => "Admin action alert", "Type" => "yesno", "Size" => "30", "Description" => "Enviar alertas para acciones administrativas"),
			...
			"reseller_group" => array("FriendlyName" => "Allow search groups", "Type" => "text", "Size" => "30", "Description" => "Mostrar la opción de búsqueda y eliminación solo a estos grupos (números de grupo separados por comas).<br/>Client Groups documentation: <a href=\"http://docs.whmcs.com/Client_Groups\" target=\"_blank\">http://docs.whmcs.com/Client_Groups</a>"),
			...
			"conn_address" => array("FriendlyName" => "Connection Address", "Type" => "radio", "Options" => "IP Address,Hostname", "Description" => "Cambie la dirección de conexión que usa Autounblock para acceder al servidor"),
			"allow_disabled" => array("FriendlyName" => "Allow disabled servers", "Type" => "yesno", "Size" => "30", "Description" => "Permitir que el administrador use servidores deshabilitados"),
		));
	return $configarray;
}
